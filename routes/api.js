...
const fs = require("fs");
let notes = require("../db/db.json"); //require json file located in /db
...
router.post("/notes", (req, res) => {
  ...
  if (title && text) {
    ...
    let notesString = JSON.stringify(notes, null, 3); //======waht is 3 here======
    ...
    fs.writeFile(
      ...
      notesString,
      (
        err //=====do i need to install fs or is that built in======
